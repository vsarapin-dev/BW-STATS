...
')
     ...
     *
     */
        class GeneralizedStatsFacade {
                    /**
         *
         *
         * @static
         */
        public static function getAllBestStats($seasonId)
        {
                        /** @var \App\Facades\GeneralizedStats\Facade\GeneralizedStats $instance */
                        return $instance->getAllBestStats($seasonId);
        }
                    /**
         *
         *
         * @static
         */
        public static function setAllBestStats($seasonId, $totalTableId)
        {
                        /** @var \App\Facades\GeneralizedStats\Facade\GeneralizedStats $instance */
                        return $instance->setAllBestStats($seasonId, $totalTableId);
        }
                    /**
         *
         *
         * @static
         */
        public static function saveEditableData($data)
        {
                        /** @var \App\Facades\GeneralizedStats\Facade\GeneralizedStats $instance */
                        return $instance->saveEditableData($data);
        }
...
namespace  {
            ...
            class GeneralizedStats extends \App\Facades\GeneralizedStats\Facade\GeneralizedStatsFacade {}
